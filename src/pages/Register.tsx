  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 py-8 md:py-16">
      <div className="bg-white p-6 md:p-10 rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-stone-200/60">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-stone-900 mb-6 md:mb-8 font-display tracking-tight">Create Account</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="SELLER">Salon Owner</option>
            </select>
          </div>
